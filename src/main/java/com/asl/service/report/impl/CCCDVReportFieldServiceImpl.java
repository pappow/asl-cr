 ...
 * @since Dec 27, 2020
 */
@Service("cccdvService")
public class CCCDVReportFieldServiceImpl extends AbstractReportService {

	public List<FormFieldBuilder> getReportFields() {
		return generateCCCDV();
	}

	private List<FormFieldBuilder> generateCCCDV() {
